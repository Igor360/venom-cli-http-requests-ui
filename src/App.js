                ...
                <div className="mt-5 flex lg:mt-0 lg:ml-4">
					<span className="ml-3 hidden sm:block">
						<button
                            ...
                            onClick={() => {
                                setIsDay(!isDay)
                                document.querySelector("html").setAttribute("data-theme", isDay ? "dark" : "pastel")
                            }}>
							{ !isDay ?<SunIcon
                    ...
                    <div className="border-t border-gray-200">
                        <dl>
                            {Object.keys(API.data[value][0]).map((url) => (
                                <div
                                    className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-2 sm:gap-2 sm:px-5 border-b border-gray-200">
                                    <Disclosure>
                                        {({open}) => (
                                            <>
                                                <Disclosure.Button
                                                                ...
                                                                <dl>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                                                                            {Object.values(API.data[value][0][url][method])[0][0].name ||
                                                                                ''}
                                                                        </dd>
                                                                    </div>
                                                                    <div
                                                                        ...
                                                                        <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                                                                            {Object.values(API.data[value][0][url][method])[0][0].info ||
                                                                                ''}
                                                                            }
                                                                        </dd>
                                                                    </div>
                                                                                                                    ...
                                                                                                                    <dl>
                                                                                                                        <div
                                                                                                                            ...
                                                                                                                            <dd className="mt-1 text-sm text-white sm:col-span-2 sm:mt-0">
																																<span
                                                                                                                                    className="block text-sm font-medium border-b border-gray-200 mb-2">
